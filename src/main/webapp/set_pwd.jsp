                    ...
                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                            ...
                                            <form  action="user.let?type=modifyPwd" method="post">
                                                <table width="100%"class="cont">
                                                    <tr>
                                                        ...
                                                        <td width="150px"><input class="text" type="password" id="oldpwd" name="oldpwd" required/></td>
                        ...
                        <tr>
                            ...
                            <td width="51%" class="left_txt">
                                <img src="./Images/icon_mail.gif" width="16" height="11"> 客户服务邮箱：2295015828@qq.com<br />
                            </td>
                            <td>&nbsp;</td><td>&nbsp;</td>
                        </tr>
                    </table>
